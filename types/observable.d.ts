...
export class Observable {
    ...
    listeners: any;
    hooks: any;
    addListener(ev?: string, handler?: () => any, id?: `${string}-${string}-${string}-${string}-${string}`, scope?: this): this;
    ...
    on(ev?: string, handler?: () => any, id?: `${string}-${string}-${string}-${string}-${string}`, scope?: this): this;
    once(ev?: string, handler?: () => any, id?: `${string}-${string}-${string}-${string}-${string}`, scope?: this): this;
